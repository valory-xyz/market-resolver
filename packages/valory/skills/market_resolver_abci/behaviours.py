...
"""This module contains the behaviours for the market resolver skill."""
...
class MarketResolverRoundBehaviour(AbstractRoundBehaviour):
    """This behaviour manages the consensus stages for the market resolver."""

    initial_behaviour_cls = RegistrationStartupBehaviour
    abci_app_cls = MarketResolverAbciApp  # type: ignore
